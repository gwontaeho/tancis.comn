...
export const comnEnvs = {
    ...
    popup: {
        ...
        cstmOfcrCd: `${process.env.REACT_APP_BASE_COMN}/comn/ppup/cstmOfcrCdPpup`,
    ...
    getCode: async (args: {
        ...
        switch (area) {
            ...
            case "cstmCd":
                ...
                break;
            case "cstmOfcrCd":
                url = `/api/v1/ptli/intptl/comnppup/cstmOfcr?usrDmnId=${usrDmnId}&usrNm=${keyword}&cstmOfceCd=${keywordName}`;
                break;
            case "vhclBodyCd":
