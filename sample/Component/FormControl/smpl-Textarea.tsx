        ...
        <Page>
            <Group>
                <form>
                    <Group.Body>
                        <Group.Row>
                            <Group.Control type="textarea" label="기본" />
                        </Group.Row>
                        <Group.Row>
                            <Group.Control type="textarea" label="필수" required={true} />
                            <Group.Col>
                                <code>{`required={true}`}</code>
                            </Group.Col>
                        </Group.Row>
                        <Group.Row>
                            <Group.Control type="textarea" label="최대 길이" maxLength={5} />
                            <Group.Col>
                        ...
                        <Group.Row>
                            <Group.Control type="textarea" label="에러" invalid={true} />
                            <Group.Col>
