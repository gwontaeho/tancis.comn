            ...
            >
                <Sample.Table
                    data={[
                        ...
                        ["leftButton?","React.ButtonHTMLAttributes<HTMLButtonElement>","",<>시간 필드(time field) 왼쪽의 버튼 배치</>,],
                        ["rightButton?","React.ButtonHTMLAttributes<HTMLButtonElement>","",<>시간 필드(time field) 오른쪽의 버튼 배치</>,],
                        ...
                        ["invalid?","any","",<>시간 필드(time field) 내용의 유효성검사 시 false일 경우에 나타내는 가상클래스</>,],
               ...
               <Sample.Code>{`<FormControl type="time" value={new Date("2024-01-03T03:24:00")} />`}</Sample.Code>
                ...
                <Page>
                    <FormControl
                        type="time"
                        onFocus={() => {console.log("Time field");
                        }}
                    />
                </Page>
