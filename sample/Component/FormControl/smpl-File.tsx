                ...
                <Sample.Table
                    data={[
                        ...
                        [
                            ...
                            "",
                            <>파일 필드(file field) 왼쪽의 버튼 배치</>,
                        ],
                        [
                            "rightButton?",
                            "React.ButtonHTMLAttributes<HTMLButtonElement>",
                            "",
                            <>파일 필드(file field) 오른쪽의 버튼 배치</>,
                        ],
                        [
                            "invalid?",
                            "any",
                            "",
                            <>파일 필드(file field) 내용의 유효성검사 시 false일 경우에 나타내는 가상클래스</>,
                        ],
                        ...
                        [
                            ...
                            "boolean",
                            "",
                            <>파일 필드(file field) 요소에 사용자가 둘 이상의 값을 입력할 수 있음을 명시</>,
                        ],
                    ]}
                />
