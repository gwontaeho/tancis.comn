    ...
    return (
        <Sample title="Password">
            ...
            >
                ...
                <Page>
                    <FormControl type="password" onChange={(event) => { alert(event.target.value)}} />
                </Page>

                <Sample.Code>{`<FormControl type="password" onBlur={() => { alert('000000')}} />`}</Sample.Code>
                <Page>
                    <FormControl type="password" onBlur={() => { alert('000000')}} />
                </Page>
                ...
                <Page>
                  <FormControl type="password" onFocus={() => { console.log('000000')}} />
                </Page>
