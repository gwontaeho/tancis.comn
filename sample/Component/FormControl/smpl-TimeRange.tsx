...
export const SampleFormControlTimeRange = () => {
...
`}</Sample.Code>
                    ...
                    <Sample.Section
                        ...
                        description={
                            <>
                                - input timerange 의 Place Holder 를 설정
                                <br />- string
                            </>
                        }
                    >
                                ...
                                <Group.Section>
                                    <Group.Row>
                                        <Group.Control
                                            ...
                                            start={{ name: "start", value: comnUtils.getDate() }}
                                            end={{ name: "end", value: comnUtils.getDate({ h: -1, mi: 10 }) }}
                                        />
                                    </Group.Row>
                                    <Group.Row>
                                        <Group.Control
...
`}</Sample.Code>
                    ...
                    <Sample.Section
                        ...
                        description={
                            <>
                                - input timerange 의 읽기전용 여부를 설정 ( default : false )
                                <br />- true | false
                            </>
                        }
                    >
...
`}</Sample.Code>
                    ...
                    <Sample.Section
                        ...
                        description={
                            <>
                                - input timerange 의 사용가능 여부를 설정 ( default : false )
                                <br />- true | false
                            </>
                        }
                    >
...
`}</Sample.Code>
                    ...
                    <Sample.Section
                        ...
                        description={
                            <>
                                - input timerange 의 필수 여부를 설정 ( default : false )
                                <br />- 라벨 영역에 빨간색 * 표시
                                <br />- true | false
                            </>
                        }
...
`}</Sample.Code>
                    ...
                    <Sample.Section
                        ...
                        description={
                            <>
                                - input timerange 하단에 message 를 표시
                                <br />- "string"
                            </>
                        }
                    >
...
`}</Sample.Code>
                    ...
                    <Sample.Section
                        ...
                        description={
                            <>
                                - input timerange 의 상세 조회 상태를 표시( default : false )
                                <br />- true | false
                            </>
                        }
                    >
...
`}</Sample.Code>
                    ...
                    <Sample.Section
                        ...
                        description={
                            <>
                                - input timerange 의 기간 설정을 위한 버튼 표시 타입
                                <br />- 3
                            </>
                        }
                    >
            ...
            <Sample.Section title="2. 컴포넌트 사용방법(추가)">
                <Layout direction="col">
                    <Sample.Section
                        ...
                        description={
                            <>
                                - input timerange 의 왼쪽에 버튼 추가 기능
                                <br />
...
`}</Sample.Code>
                    ...
                    <Sample.Section
                        ...
                        description={
                            <>
                                - input timerange 의 오른쪽에 버튼 추가 기능
                                <br />
            ...
            <Sample.Section title="3. 컴포넌트 사용방법(이벤트)">
                <Layout direction="col">
                    <Sample.Section
                        ...
                        description={
                            <>
                                - input timerange 의 Change Event Handler
                                <br />
                                - input timerange 의 value 를 parameter로 전달
                                <br />
                                {`- onChange={(e)=>{})}`}
                            </>
                        }
...
`}</Sample.Code>
                    ...
                    <Sample.Section
                        ...
                        description={
                            <>
                                - input timerange 의 Blur Event Handler
                                <br />
                                - input timerange 의 blur event 를 parameter로 전달
                                <br />
                                {`- onBlur={(e)=>{})}`}
                            </>
                        }
                    ...
                    <Sample.Section title="4.1 스키마를 이용한 컴포넌트 사용 예시">
                        <Group>
                            <Group.Body>
                                <Group.Section>
                                    <Group.Row>
                                        <Group.Control {...form.schema.timerange1} />
                                    </Group.Row>
                                    <Group.Row>
                                        <Group.Control {...form.schema.timerange2} />
                                    </Group.Row>
                                    <Group.Row>
                                        <Group.Control {...form.schema.timerange3} />
                                    </Group.Row>
                                </Group.Section>
                            </Group.Body>
                            <Group.Footer>
